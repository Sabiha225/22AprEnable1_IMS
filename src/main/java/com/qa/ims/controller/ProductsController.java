...
public class ProductsController implements CrudController<Products> {
	...
	public ProductsController(ProductsDAO productsDAO, Utils utils) {
		super();
	...
	public Products update() {
		...
		Double cost = utils.getDouble();
		Products product = new Products(id, name, cost);
