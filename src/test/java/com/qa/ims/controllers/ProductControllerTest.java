...
public class ProductControllerTest {
	...
	public void testCreate() {
		final String Product_name = "Foundation";
		final Double Product_cost = 28.00;
	...
	public void testReadAll() {
		...
		product.add(new Products(1L, "Mascara", 9.99));
	...
	public void testUpdate() {
		Products updated = new Products(1L, "Mascara", 9.99);
